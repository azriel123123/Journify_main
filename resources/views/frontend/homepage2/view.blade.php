...
<body class="bg-gradient-to-tr from-indigo-100 via-pink-100 to-yellow-100 min-h-screen text-gray-900 font-inter">
                ...
                <form class="space-y-10 bg-white/40 border border-white/30 backdrop-blur-2xl rounded-3xl shadow-xl p-8">
                    ...
                    <div>
                        ...
                        <textarea id="q1" rows="3" disabled
                            class="editable w-full p-4 rounded-xl border border-indigo-200 bg-white/60 resize-none shadow-inner focus:outline-none focus:ring-2 focus:ring-indigo-300">I'm feeling calm and optimistic today.</textarea>
                        <div class="mt-2 text-right">
                            <button type="button" onclick="toggleEdit('q1')"
                                class="edit-btn px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold shadow">Edit</button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="q2" rows="3" disabled
                            class="editable w-full p-4 rounded-xl border border-indigo-200 bg-white/60 resize-none shadow-inner focus:outline-none focus:ring-2 focus:ring-indigo-300">I enjoyed a walk in the park and saw a beautiful sunset.</textarea>
                        <div class="mt-2 text-right">
                            <button type="button" onclick="toggleEdit('q2')"
                                class="edit-btn px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold shadow">Edit</button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="q3" rows="3" disabled
                            class="editable w-full p-4 rounded-xl border border-indigo-200 bg-white/60 resize-none shadow-inner focus:outline-none focus:ring-2 focus:ring-indigo-300">Grateful for time spent with family and friends.</textarea>
                        <div class="mt-2 text-right">
                            <button type="button" onclick="toggleEdit('q3')"
                                class="edit-btn px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold shadow">Edit</button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="q4" rows="4" disabled
                            class="editable w-full p-4 rounded-xl border border-indigo-200 bg-white/60 resize-none shadow-inner focus:outline-none focus:ring-2 focus:ring-indigo-300">I want to remember this day because everything felt in harmony.</textarea>
                        <div class="mt-2 text-right">
                            <button type="button" onclick="toggleEdit('q4')"
                                class="edit-btn px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold shadow">Edit</button>
                        </div>
                    </div>
    ...
    <script>
        function toggleEdit(id) {
            ...
            const btn = textarea.parentElement.querySelector('.edit-btn');
            ...
            if (textarea.disabled) {
                ...
                console.log(`Saved [${id}]:`, textarea.value);
                // Simpan ke backend nanti di sini kalau pakai API
            }
        }
    </script>
</body>
